...
const ProductDisplay = () => {
  ...
  const productSets = [
    [
      {
        imageSrc: "/image 80 (1).png",
        title: "Dry Vacuum Cleaner, Model : VP 930",
        backgroundSrc: "/Rectangle 81.png",
        backgroundTitle: "Dry Vacuum Cleaner, Model : VP 930"
      },
      {
        imageSrc: "/image 81 (1).png",
        title: "Dry Vacuum Cleaner, Model : VL 500",
        backgroundSrc: "/Rectangle 81.png",
        backgroundTitle: "Dry Vacuum Cleaner, Model : VL 500"
      },
      {
        imageSrc: "/image 82 (1).png",
        title: "Dry Vacuum Cleaner, Model : GD 10",
        backgroundSrc: "/Rectangle 81.png",
        backgroundTitle: "Dry Vacuum Cleaner, Model : GD 10"
      }
    ],
    [
      {
        imageSrc: "/image 83 (1).png",
        title: "Single Disc Burnisher, Model : LS 160",
        backgroundSrc: "/Rectangle 81.png",
        backgroundTitle: "Single Disc Burnisher, Model : LS 160"
      },
      {
        imageSrc: "/image 85 (1).png",
        title: "Single Disc Burnisher, Model : FM 400",
        backgroundSrc: "/Rectangle 81.png",
        backgroundTitle: "Single Disc Burnisher, Model : FM 400"
      },
      {
        imageSrc: "/image 86 (1).png",
        title: "Ride On Scrubber Dryer, Model : SC 450",
        backgroundSrc: "/Rectangle 81.png",
        backgroundTitle: "Ride On Scrubber Dryer, Model : SC 450"
      }
    ],
    [
      {
        imageSrc: "/image 87 (1).png",
        title: "Manuel Sweeper, Model : PS 480",
        backgroundSrc: "/Rectangle 81.png",
        backgroundTitle: "Manuel Sweeper, Model : PS 480"
      },
      {
        imageSrc: "/image 88 (1).png",
        title: "Manuel Sweeper, Model : SW 750",
        backgroundSrc: "/Rectangle 81.png",
        backgroundTitle: "Manuel Sweeper, Model : SW 750"
      },
      {
        imageSrc: "/image 89 (1).png",
        title: "Ride On Sweeper, Model : SR 1101",
        backgroundSrc: "/Rectangle 81.png",
        backgroundTitle: "Ride On Sweeper, Model : SR 1101"
      }
    ]
  ];
  ...
  return (
    <div className="relative flex flex-row items-center justify-center mt-10 space-x-8">
      ...
      >
        <Image src="/vector.svg"alt="Left Arrow" width={24} height={24} />
      </button>
      ...
      >
        <Image src="/vector (1).svg" alt="Right Arrow" width={24} height={24} />
      </button>
    </div>
  );
};
