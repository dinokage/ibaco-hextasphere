...
const ProductDisplay = () => {
  ...
  const productSets = [
    [
      {
        imageSrc: "/image 78 (1).png",
        title: "Sterile - Formulations",
        backgroundSrc: "/Rectangle 81.png",
        backgroundTitle: "Sterile - Formulations"
      },
      {
        imageSrc: "/image 79 (1).png",
        title: "Modular Process Systems",
        backgroundSrc: "/Rectangle 81.png",
        backgroundTitle: "Modular Process Systems"
      },
    ]
  ];
...
const ProductTabs = () => {
  ...
  const handleTabClick = (index: number) => {
    setActiveTab(index);
    if (tabs[index] === 'Praj Hipurity Systems') {
