      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row justify-between gap-8">
          ...
          <div className="w-full md:w-1/4">
            <div className="bg-[#ecdfcf] rounded-lg p-4">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-[#29567a] font-bold text-lg">Contact US</h3>
                <Image
                  src="/contact.png"
                  alt="Contact"
                  width={100}
              ...
              <form className="space-y-2">
                <div className="flex items-center bg-[#fff9e3] rounded px-3 py-1.5">
                  <span className="text-[#6a6a6a] mr-2">👤</span>
                  <input
                    type="text"
                    placeholder="Your Name"
                    className="bg-transparent w-full text-[#606060] outline-none text-sm"
                  />
                </div>

                <div className="flex items-center bg-[#fff9e3] rounded px-3 py-1.5">
                  <span className="text-[#6a6a6a] mr-2">✉️</span>
                  <input
                    type="email"
                ...
                <div className="flex items-center bg-[#fff9e3] rounded px-3 py-1.5">
                  <span className="text-[#6a6a6a] mr-2">🔧</span>
                  <select className="bg-transparent w-full text-[#606060] outline-none text-sm">
                    <option>Services</option>
                    <option>Air Compressors</option>
                    <option>Pumps</option>
                    <option>Valves</option>
                    <option>Drive Engineering</option>
                ...
                <textarea
                  placeholder="Message"
                  rows={3}
                  className="w-full bg-[#fff9e3] rounded p-2 text-[#606060] outline-none text-sm"
                ></textarea>

                <div className="flex justify-end">
                  <button
                    type="submit"
                    className="bg-[#00aeef] text-white uppercase text-xs font-medium py-1 px-3 rounded"
                  >
                    SEND MESSAGE
                  </button>
                </div>
